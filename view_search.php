<?php
	...
	if (isset ($search))
	{
		...
		{
			exit ("<p>Задан пустой поисковый запрос, или он менее 3-х символов.</p>");
		}
		$query = trim($query); 
	...
	{
		exit("<p>Задан пустой поисковый запрос.</p>");
	}	
				...
				<?php  
					do{
						printf ("
							...
							<h2>%s</h2>
							<p>%s</p>
							<a class='more' href='view_news.php?id=%s'>Прочитать</a>
							<div class='clear'></div>
