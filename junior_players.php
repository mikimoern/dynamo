<?php
	...
	$goalkeeper_player = mysql_query ("SELECT * FROM players WHERE team=2 		
	...
	$protector_player = mysql_query ("SELECT * FROM players WHERE team=2 		
	...
	$midfielder_player = mysql_query ("SELECT * FROM players WHERE team=2 		
	...
	$attacker_player = mysql_query ("SELECT * FROM players WHERE team=2 		
