...
<body>
	<div id="wrapper">
		...
		<div id="content">
			...
			<div id="center">
				<div id="contentNews">
					<div class='titleNews'>Pедагувати інформацію про тренера</div>
					<?php 
					...
					if (!isset($_GET['id'])) {
						...
						$myrow = mysql_fetch_array($result);
							...
							do{
							printf ("
								<p><a href = 'edit_player.php?id=%s'>%s</a></p>",$myrow["id"], $myrow["name"]);	
							}	
					    ...
					    print <<<HERE
							<div class="add">
								<form name="add_player" action="update_player.php" method="post">
									<div>
										<p><input type="text" name="name" value="$myrow[name]" /></p>
										<p><input type="text" name="number" value="$myrow[number]" /></p>
